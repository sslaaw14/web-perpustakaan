    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <center><h3 class="card-title">Seoul Library Mall</h3></center>
			  <h5 align="center">Make book your first friend</h5>
              <center><img src="33.jpeg" width="900px" height="430px"></center>
            </div>
          </div>
        </div>
      </div>
