          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview"><a href="#"><i class="fa fa-laptop"></i><span>Buku TA</span><i class="fa fa-angle-right"></i></a>
              <ul class="treeview-menu">
                ...
                <li><a href="editta.php"><i class="fa fa-circle-o"></i> Update Buku</a></li>
              </ul>
            </li>
...
<form action='tambahta.php' method="POST">
<tr> <td>id buku</td>
	<td>:</td>
...
<table class="table">	
	...
	<th>PENGARANG</th>
	<th>JENIS BUKU</th>
		<?php $query="SELECT * FROM DAFTAR_BUKU WHERE JENIS_BUKU='ta'";
								...
								echo " <td> <a href='editta.php?action=edit&id=$res[ID_BUKU]'>Edit</a></td>";
								echo " <td> <a href='?action=del&id=$res[ID_BUKU]'>Delete</a></td>\n</tr>\n";
								}
			?>
</table>
<?php
				...
				if ($_GET['action'] == 'del') {
					...
					$s=oci_parse($conn,$query);
					oci_execute($s);
					echo "<script>location='insertta.php';</script>";
				}else if ($_GET['action'] == 'edit') {
					$id = $_GET['id'];
					$judulb = $_GET['judulb'];
					$pengarang = $_GET['pengarang'];
					$j_buku = $_GET['j_buku'];
					$query= "UPDATE DAFTAR_BUKU SET JUDUL='$judulb', PENGRANAG='$pengarang',JENIS_BUKU='$j_buku'  WHERE ID_BUKU='$_GET[id]'";
					echo $query;
					$s=oci_parse($conn, $query);
					oci_execute($s);
					echo "<script>location='insertta.php';</script>";
