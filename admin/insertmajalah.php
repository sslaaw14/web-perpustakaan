...
<table class="table">	
	...
	<th>PENERBIT</th>
	<th>JENIS BUKU</th>
		<?php $query="SELECT * FROM DAFTAR_BUKU WHERE JENIS_BUKU='majalah'";
								...
								echo " <td> <a href='editmajalah.php?action=edit&id=$res[ID_BUKU]'>Edit</a></td>";
...
<?php
				...
				if ($_GET['action'] == 'del') {
					...
					$j_buku = $_GET['j_buku'];
					$query= "UPDATE DAFTAR_BUKU SET JUDUL='$judulb', PENGRANAG='$pengarang', PENERBIT='$penerbit', JENIS_BUKU='$j_buku'  WHERE ID_BUKU='$_GET[id]'";
					echo $query;
					$s=oci_parse($conn, $query);
					oci_execute($s);
					echo "<script>location='insertmajalah.php';</script>";
